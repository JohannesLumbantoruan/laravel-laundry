    ...
    <div class="container">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('editPelangganAksi', $pelanggan->pelanggan_id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pelanggan_nama" class="form-control" placeholder="Masukkan nama pelanggan" value="{{ $pelanggan->pelanggan_nama }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pelanggan_hp" class="form-control" placeholder="Masukkan no. hp pelanggan" value="{{ $pelanggan->pelanggan_hp }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pelanggan_alamat" class="form-control" placeholder="Masukkan alamat pelanggan" value="{{ $pelanggan->pelanggan_alamat }}">
